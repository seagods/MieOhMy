...
\bibliography{/home/daddio/Programs/MieOhMy/Theory/Miebib.bib}
%\bibliographystyle{prsty}
...
are returned as zero by zbesj? According to Abramowitz and Stegun
 \textsection 9.3 \cite{AbramowitzStegun:Miebib},  for large orders
...
these the $C$'s and $D$'s
 of eqn.20 in \textsection8 (eqn.157) of \cite{EMScatt:Miebib} can be calculated.
\begin{equation}
...
along the $x$ axis in intervals of $\Delta $. The author finds that $\Delta=1$
 is a reasonable value in practise. For each interval, we have  an $N_g$ 
point Gauss-Legendre integration rule, and
...
Now we return to eqn.29.  We shall repeat Dave here \cite{Dave1:Miebib}, 
